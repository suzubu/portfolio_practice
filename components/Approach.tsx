    ...
    <section className="w-full py-20 ">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        <Card
          ...
          description="We'll collaborate to understand your goals and create a roadmap to achieve them."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          description="Once we agree on the plan, I'll start designing and developing your project."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        <Card
          ...
          description="This is where the magic happens. I'll bring your project to life and launch it."
        >
          <CanvasRevealEffect
            animationSpeed={3}
